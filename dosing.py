...
def dose_amount():
    ...
    weight = input_patient_weight()
    weight_kg = convert_kg(weight)
    dosage_mg_first_day = calculate_dosage(diagnosis, weight_kg)
    output_results(weight_kg, dosage_mg_first_day)
